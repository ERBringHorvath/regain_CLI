...
def main():
    ap = argparse.ArgumentParser(description="Run Bayesian Network analysis (small datasets)")
    ...
    sh_path = os.path.join(script_dir, "bnQueryGrain.sh")
    ...
    # forward unknown args to R for future-proofing
    cmd += unknown
    run(cmd)
